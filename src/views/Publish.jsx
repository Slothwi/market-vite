  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!accessToken) {
        ...
        alert(
          "No se ha encontrado un token de acceso. Por favor, inicie sesión."
        );
        return;
      }
      ...
      alert(
        "Se produjo un error al intentar crear el producto. Por favor, inténtelo de nuevo más tarde."
      );
    }
  };
    ...
    <>
      <Container className="access">
        ...
        <Form className="text-white" onSubmit={handleSubmit}>
          ...
          <Form.Group className="mb-3" controlId="formBasicPrice">
            <Form.Label>Imagen del archivo:</Form.Label>
            <Accept setFormData={setFormData} formData={formData} />
          </Form.Group>
          <Row>
            <Col>
