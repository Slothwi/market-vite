...
function Navigation() {
    ...
    return (
        <Navbar expand="lg" className="navbar" fixed='top'>
            ...
            <Container>
                <Navbar.Brand  className="text-white" href="/home">Autos Parts</Navbar.Brand>
                <Navbar.Toggle aria-controls="basic-navbar-nav" />
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto">
                        <Nav.Link className="text-white" href="/">Market</Nav.Link>
                        <Nav.Link className="text-white" href="/Ventas">Carrito</Nav.Link>
